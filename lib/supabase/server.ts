...
export async function createServerClient() {
  ...
  console.log("[v0] Supabase client created:", typeof client, client.from ? "has .from method" : "missing .from method")
...
/**
 * ✅ NUEVO ESTÁNDAR: Crear cliente Supabase para Server Components
...
// 🔄 COMPATIBILIDAD: Mantener función existente durante migración
